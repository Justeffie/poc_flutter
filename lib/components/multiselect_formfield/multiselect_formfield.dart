...
/// Este componente es una modificacion de multiselect_formfield original
/// solo va a funcionar para los tipo de enum del backend que tenga id y descripcion.
/// Se utiliza porque el original tiene limitaciones con request http
